...
const queries = [
    'Telugu', 'SBP', 'Devi Sri Prasad', 'Mani Sharma', 'love', 'Anoop Rubens','S. P. Balasubrahmanyam','Ilaiyaraaja','K.J. Yesudas','M. M. Keeravani','Annamayya Keerthana','G.V. Prakash Kumar', 'Anurag Kulkarni', 'Mahesh Babu', 'Thaman S', 'Ram Miriyala', 'Bheems Ceciroleo','Yuvan Shankar Raja','Ramajogayya Sastry','new remix'
];
...
function populateSongSelector() {
    ...
    songs.forEach((song, index) => {
        ...
        option.value = index;
        option.text = `${song.name} - ${song.primaryArtists} - ${song.album}`;
...
function loadSongDetails(index) {
    ...
    if (selectedSong) {
      ...
      document.body.style.backgroundImage= `url(https://images.pexels.com/photos/4840134/pexels-photo-4840134.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)`;
